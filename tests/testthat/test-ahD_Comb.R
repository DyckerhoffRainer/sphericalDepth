test_that("ahD_Comb and ahD_Rec work", {
  ...
  # combinatorial algorithm, pass a vector of probabilitiues to mass, different target dimensions and methods
  ...
  res[6:10,] <- res[6:10,] * n
  # combinatorial algorithm, pass a vector of multiplicieties to mass, different target dimensions and methods
