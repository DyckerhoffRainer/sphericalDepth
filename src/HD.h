...
namespace DataDepth {
  ...
  double HD_Comb(const double* z, const dyMatrixClass::cMatrix xx);
  ...
  double HD_Comb2(const double* z, const dyMatrixClass::cMatrix xx);
  ...
  double HD_Rec(const double* z, const dyMatrixClass::cMatrix& xx);
  ...
  template<typename val_t>
  val_t nHD_Comb2(const dyMatrixClass::cMatrix& xx, const val_t val[]);
